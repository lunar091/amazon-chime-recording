...
`;
  ...
  public set showConfigDropdown(shouldShow: boolean) {
    ...
    (
      this.querySelector('.button-video-tile-config-drop') as HTMLElement
    ).style.display = display;
    (this.querySelector('.video-tile-pause') as HTMLElement).style.display =
      display;
  }
  ...
  public set showRemoteVideoPreferences(shouldShow: boolean) {
    const display: string = shouldShow ? 'block' : 'none';
    (
      this.querySelector('.target-resolution-header') as HTMLElement
    ).style.display = display;
    (
      this.querySelector('.target-resolution-toggle') as HTMLElement
    ).style.display = display;
    (
      this.querySelector('.video-priority-header') as HTMLElement
    ).style.display = display;
    (
      this.querySelector('.video-priority-toggle') as HTMLElement
    ).style.display = display;
  }
  ...
  showVideoStats(
    ...
    let statsInfo: HTMLDivElement = this.querySelector(
      '#stats-info'
    ) as HTMLDivElement;
    if (!statsInfo) {
  ...
  //this.querySelector('.video-tile-nameplate').innerHTML = myAvatar.generate();
  }
  ...
  async connectedCallback() {
    ...
    (
      this.querySelector('.button-video-tile-config-drop') as HTMLElement
    ).innerHTML = require('../../../node_modules/open-iconic/svg/cog.svg');
